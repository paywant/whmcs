 ...
 * @return array
 */
function paywantbanka_MetaData()
{
    return array(
        'DisplayName' => 'Paywant Banka Havale/Eft/Atm',
        'APIVersion' => '1.1'
    );
}

function paywantbanka_config()
{
    return array(
		"FriendlyName" => array(
        "Type" => "System",
        "Value" => "Paywant Banka Havale/Eft/Atm"
        ),
        'durum' => array(
            'FriendlyName' => 'Durum',
            'Type' => 'yesno',
...
function paywantbanka_link($params)
{
    // Invoice
    ...
    if ($params['durum'] == 'on') {
		if($currency == "TRY")
		{
			...
			$userIPAdresi = paywantIPAddress2();
