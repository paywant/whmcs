 ...
 * @return array
 */
function paywant_MetaData()
{
    return array(
        'DisplayName' => 'Paywant Kredi Kartı',
        'APIVersion' => '1.1'
    );
}

function paywant_config()
{
    return array(
		"FriendlyName" => array(
        "Type" => "System",
        "Value" => "Paywant Kredi Kartı"
        ),
        'durum' => array(
            'FriendlyName' => 'Durum',
            'Type' => 'yesno',
